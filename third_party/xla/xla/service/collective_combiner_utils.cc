...
// Defines the multiplier which is used to determine how much memory is left for
// additional allocation.
constexpr double kMemorySlopFactor = 0.95;
...
int64_t ComputeSuggestedCombinerThreshold(
  ...
  return base_limit * kMemorySlopFactor - peak_memory_bytes;
}
