...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_enable_finite_math(false);
  return opts;
}
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(
      tsl::Flag("xla_enable_finite_math",
                bool_setter_for(&DebugOptions::set_xla_enable_finite_math),
                debug_options->xla_enable_finite_math(),
